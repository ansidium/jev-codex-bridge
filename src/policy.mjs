 ...
 * @param {boolean} input.hasPriorModel whether this conversation has an established model
 * @returns {{tier: string, reason: string, changed: boolean}}
 */
export function decide({ prompt, jev, current, available, contextTokens = 0, hasPriorModel = true }) {
  ...
  if (hasPriorModel && rankOf(target) < rankOf(current) && contextTokens > THRESHOLDS.downgradeMaxContextTokens) {
